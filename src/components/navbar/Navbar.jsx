...
function Navbar() {
  return (
    <div className="fixed top-0 left-0 z-[10] w-full h-14 bg-[#1d1b1b7e] flex items-center justify-between text-zinc-400 px-4 md:px-6">
      {/* logo */}
      ...
      <div className="flex gap-[5vw] items-center">
        <NavLink
          className="flex text-[2.1vh] md:text-[2.8vh] hover:text-black"
          to="/"
        >
          Home
        </NavLink>

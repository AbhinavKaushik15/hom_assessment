...
const Contact = () => {
  return (
    <div className="w-full min-h-[100vh] flex flex-col items-center py-5 gap-9 bg-gradient-to-b from-blue-300 to-blue-500">
      ...
      {/* Contact Form */}
      <div className="w-[90vw] sm:w-[80vw] min-h-[95vh] pt-7 rounded-xl shadow-xl backdrop-blur-md bg-[#fafafa1a] border-[1.8px] border-zinc-300 px-5 flex flex-col gap-5">
